                ...
                <div className={style.paymentWrapper}>
                  <div className={style.paymentContainer}>
                    ...
                    <div className={style.isPassengerCardholderContainer}>
                      <div
                        className={style.isPassengerCardholderTitleContainer}
                      >
                        <span
                          className={
                            riderDetails
                      ...
                      <div
                        className={style.isPassengerCardholderSwitchContainer}
                      >
                    ...
                    {!riderDetails && (
                      <div className={style.passengerDetailWrapper}>
                        ...
                        <div
                          className={style.cardholderInformationInputsWrapper}
                        >
                          <div
                            className={
                    ...
                    <div className={style.cardholderInformationWrapper}>
                      <div
                        className={style.cardholderInformationTitleContainer}
                      >
                        <span
